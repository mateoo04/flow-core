(function () {
  ...
  function syncBoardForViewport() {
    document.querySelectorAll("[data-board-mobile-toggle]").forEach(function (toggle, index) {
  ...
  document.addEventListener("click", function (e) {
    var toggle = e.target.closest("[data-board-mobile-toggle]");
  ...
  syncBoardForViewport();
  mobileQuery.addEventListener("change", syncBoardForViewport);
})();
